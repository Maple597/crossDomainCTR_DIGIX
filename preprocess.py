...
def preprocess(input_dir):
    ...
    # # Maybe here we need to change train_data_feeds_df into test_data_feeds_df
    # merge_data(input_dir, test_data_df, test_data_feeds_df, Const.MERGE_TEST_DATA_FILE)
